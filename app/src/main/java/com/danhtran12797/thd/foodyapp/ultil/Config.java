...
public class Config {
    ...
    public static String vnp_HashSecret = "BTKYNMVIXIVDOYUJXHRATLSGMNXXGJPG";
    public static String vnp_TmnCode = "LD62C7RJ";
    public static String vnp_Returnurl = "https://applon12797.000webhostapp.com/foody/navigate_vnpay.php";
    ...
    public static String getIpAddress(Context context1) {
