...
import com.danhtran12797.thd.foodyapp.adapter.IntroViewPagerAdapter;
import com.danhtran12797.thd.foodyapp.model.ScreenItem;
import com.google.android.material.tabs.TabLayout;

import java.util.ArrayList;
import java.util.List;

import static com.danhtran12797.thd.foodyapp.ultil.Ultil.savePrefsData;
...
//        if (restorePrefData()) {
//            Intent mainActivity = new Intent(getApplicationContext(), TestActivity.class);
...
//        getSupportActionBar().hide();
        ...
        btnGetStarted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                savePrefsData(IntroActivity.this);
                finish();
